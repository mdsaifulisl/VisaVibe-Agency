...
import { FaPlaneDeparture, FaPlaneArrival, FaCalendarAlt, FaSearch, FaTicketAlt } from 'react-icons/fa';
  ...
  return (
    <div className="air-tickets-page pb-5">
      ...
      <section className="about-hero d-flex align-items-center justify-content-center text-center text-white mb-5" 
        style={{backgroundImage: `linear-gradient(rgba(13, 129, 129, 0.7), rgba(171, 204, 204, 0.7)), url('https://images.unsplash.com/photo-1499750310107-5fef28a66643?auto=format&fit=crop&w=1200&q=80')`, height: '350px'}}>
        <div className="container">
          <h1 className="display-4 fw-bold">Book Your Flight</h1>
          <p className="lead">Get the best deals on international and domestic air tickets</p>
        </div>
      </section>
        ...
        <div className="row g-4">
          ...
          <div className="col-lg-8">
                ...
                {airTicketDeals.map((deal) => (
                  <div className="col-12" key={deal.id}>
                    <div className="flight-deal-card p-3 border rounded-4 d-flex flex-column flex-md-row align-items-center gap-4 transition-all hover-shadow">
                      ...
                      <button className="btn btn-teal rounded-pill px-4">Book Now</button>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="info-section p-4 bg-light rounded-4">
              <h5 className="fw-bold text-teal mb-3">Why Book With Expert Travel?</h5>
              <div className="row g-3">
                <div className="col-md-6">
                  <p className="small text-secondary">✅ Instant Confirmation & E-Ticket</p>
                  <p className="small text-secondary">✅ 24/7 Dedicated Support Team</p>
                </div>
                <div className="col-md-6">
                  <p className="small text-secondary">✅ No Hidden Booking Charges</p>
                  <p className="small text-secondary">✅ Easy Refund & Re-issue Policy</p>
                </div>
              </div>
            </div>
          </div>
