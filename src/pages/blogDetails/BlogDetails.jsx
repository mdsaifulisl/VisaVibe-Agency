...
const BlogDetails = () => {
  ...
  const post = BlogJsonData.find((item) => item.id === parseInt(id));
        ...
        <div className="row g-5">
          ...
          <div className="col-lg-8">
            ...
            <div className="blog-content-area mb-5">
              <div 
                className="ql-editor p-0 additional-details fs-5 text-secondary"
                style={{ lineHeight: '1.8' }}
                dangerouslySetInnerHTML={{ __html: post.content }} 
              />
            </div>

            {/* Gallery Section - Using your Gallery Component */}
